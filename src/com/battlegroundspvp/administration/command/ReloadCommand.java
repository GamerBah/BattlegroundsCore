    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!gameProfile.hasRank(Rank.OWNER)) {
            ...
            if (args[0].equalsIgnoreCase("server")) {
                plugin.getServer().broadcastMessage(new MessageBuilder(ChatColor.RED).bold().create() + "SERVER: " + ChatColor.GRAY + "Reloading in 5 seconds. Hang in there!");
                ...
                plugin.getServer().getScheduler().runTaskLater(plugin, () -> {
                    ...
                    plugin.getServer().broadcastMessage(new MessageBuilder(ChatColor.RED).bold().create() + "SERVER: " + ChatColor.GRAY
                            + "Server Reload was a " + new MessageBuilder(ChatColor.GREEN).bold().create() + "success" + ChatColor.GRAY + "! Now go have fun!");
            ...
            if (args[0].equalsIgnoreCase("plugin")) {
                ...
                plugin.getServer().getScheduler().runTaskLater(plugin, () -> {
                    ...
                    plugin.getServer().broadcastMessage(new MessageBuilder(ChatColor.RED).bold().create() + "SERVER: " + ChatColor.GRAY
                            + "Reload was a " + new MessageBuilder(ChatColor.GREEN).bold().create() + "success" + ChatColor.GRAY + "! Now go have fun!");
                }, 100);
            }
        }
        return false;
        ...
        for (Player players : plugin.getServer().getOnlinePlayers()) {
            ...
            plugin.getServer().getScheduler().runTaskLater(plugin, players::closeInventory, 10L);
                    /*if (KSlotsMenu.usingSlots.containsKey(players)) {
                        ...
                        players.sendMessage(ChatColor.YELLOW + "and you've been refunded " + new MessageBuilder(ChatColor.AQUA).bold().create() + KSlotsMenu.usingSlots.get(players) * 400 + " Souls");
                    }*/
