package com.battlegroundspvp.administration.donation;
...
public class DonationMessages {
    ...
    public void sendEssensePurchaseMessage(Player player, Essence.Type type) {
        ...
        player.sendMessage(" ");
        player.sendMessage(new MessageBuilder(ChatColor.GREEN).bold().create() + "   THANKS FOR YOUR PURCHASE!");
    ...
    public void sendEssenceActivationMessage(Essence.Type type, Player activator) {
        ...
        for (Player player : plugin.getServer().getOnlinePlayers()) {
            ...
            player.sendMessage("    " + new MessageBuilder(ChatColor.GOLD).bold().create() + (!player.getName().equals(plugin.getConfig().getString("essenceOwner"))
                    ? activator.getName() : "You") + new MessageBuilder(ChatColor.YELLOW).bold().create() + " activated a Battle Essence!");
