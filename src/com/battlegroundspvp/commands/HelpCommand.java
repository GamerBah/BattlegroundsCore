...
public class HelpCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            player.sendMessage(new ColorBuilder(ChatColor.DARK_AQUA).bold().create() + " /ping " + ChatColor.GRAY + "- Shows you your connection to Battlegrounds");
            player.sendMessage(new ColorBuilder(ChatColor.DARK_AQUA).bold().create() + " /refer " + ChatColor.GRAY + "- Refer the player who invited you!");
