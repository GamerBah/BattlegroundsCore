...
public class UpdateRunnable implements Runnable {
            ...
            try {
                ...
                plugin.getServer().getScheduler().runTaskLater(plugin, () -> {
                    ...
                    plugin.getServer().broadcastMessage(new MessageBuilder(ChatColor.RED).bold().create() + "SERVER: " + ChatColor.GRAY
                            + "Update was a " + new MessageBuilder(ChatColor.GREEN).bold().create() + "success" + ChatColor.GRAY + "! Now go have fun!");
                }, 60L);
            } catch (Throwable throwable) {
    ...
    private void revert() {
        ...
        plugin.getServer().broadcastMessage(new MessageBuilder(ChatColor.RED).bold().create() + "SERVER: " + ChatColor.GRAY
                + "Update was a " + new MessageBuilder(ChatColor.RED).bold().create() + "failure" + ChatColor.GRAY + "!");
        plugin.getServer().broadcastMessage(new MessageBuilder(ChatColor.RED).bold().create() + "SERVER: " + ChatColor.GRAY
