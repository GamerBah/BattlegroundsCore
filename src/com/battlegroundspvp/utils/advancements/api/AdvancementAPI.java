package com.battlegroundspvp.utils.advancements.api;
...
public class AdvancementAPI {
    ...
    private int counter = 1, iconData;

    private Set<Trigger.TriggerBuilder> triggers;

    private AdvancementAPI(NamespacedKey id, String parent, String icon, int iconData, String background, TextComponent title, TextComponent description, FrameType frame, boolean announce, boolean toast, boolean hidden, int counter, Set<Trigger.TriggerBuilder> triggers) {
        this.id = id;
        this.parent = parent;
        this.icon = icon;
    ...
    public String getJSON() {
        ...
        icon.addProperty("data", getIconData());
    ...
    public static class AdvancementAPIBuilder {
        ...
        public AdvancementAPI build() {
            ...
            return new AdvancementAPI(id, parent, icon, iconData, background, title, description, frame, announce, toast, hidden, counter, triggers);
        }
